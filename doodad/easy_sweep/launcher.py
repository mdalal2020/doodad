...
class DoodadSweeper(object):
    def __init__(
        ...
        self.mounts = mounts
        self.mount_out_local = mount.MountLocal(
            local_dir=local_output_dir, mount_point=docker_output_dir, output=True
        )
        self.mount_out_s3 = mount.MountS3(
            s3_path="exp_logs", mount_point=docker_output_dir, output=True
        )
...
if __name__ == "__main__":
    ...
    sweep_params = {"param1": [0, 1, 2], "param2": ["a", "b"]}
